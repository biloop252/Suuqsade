...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!page) {
    return {
      title: 'About Us - Suuqsade Marketplace',
      description: 'Learn about Suuqsade Marketplace, our mission, values, and commitment to providing quality products and exceptional service.',
    };
  }

  return {
    title: page.meta_title || page.title,
    description: page.meta_description || `Learn about ${page.title} on Suuqsade Marketplace`,
