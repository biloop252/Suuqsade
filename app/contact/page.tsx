...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!page) {
    return {
      title: 'Contact Us - Suuqsade Marketplace',
      description: 'Get in touch with Suuqsade Marketplace. Find our contact information, office address, and customer support details.',
    };
  }

  return {
    title: page.meta_title || page.title,
    description: page.meta_description || `Get in touch with ${page.title} at Suuqsade Marketplace`,
