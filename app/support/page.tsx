        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We're here to help! Get support for your orders, account, or any questions you may have.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white p-6 rounded-lg shadow text-center">
              ...
              <a href="mailto:support@suuqsade.com" className="inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    {selectedTicket.status !== 'closed' && (
                      <div>
                        <h4 className="text-sm font-medium text-gray-900 mb-4">Reply</h4>
                        <div className="space-y-4">
                          <textarea
                            value={newMessage}
