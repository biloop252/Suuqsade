...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!page) {
    return {
      title: 'Shipping Policy - Suuqsade Marketplace',
      description: 'Review our shipping policy, including delivery methods, costs, and processing times for orders placed on Suuqsade Marketplace.',
    };
  }

  return {
    title: page.meta_title || page.title,
    description: page.meta_description || `Review our ${page.title} on Suuqsade Marketplace`,
