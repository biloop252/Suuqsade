...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!page) {
    return {
      title: 'Careers - Suuqsade Marketplace',
      description: 'Explore career opportunities at Suuqsade Marketplace. Join our team and help us build the future of e-commerce.',
    };
  }

  return {
    title: page.meta_title || page.title,
    description: page.meta_description || `Explore ${page.title} opportunities at Suuqsade Marketplace`,
