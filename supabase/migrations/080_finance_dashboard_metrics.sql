-- Admin finance KPIs (from vendor_commissions rows dated in range):
-- total_sales: SUM(order_amount)
-- admin_commission: SUM(admin_amount)
-- pending_payout: SUM(commission_amount) — vendor share on those lines
