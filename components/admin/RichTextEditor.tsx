    ...
    <div className={className}>
      ...
      {isSourceMode ? (
        <textarea
          ...
          className="border border-gray-200 border-t-0 rounded-b-md px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-primary w-full font-mono text-sm"
        ...
        <div
          ...
          className="border border-gray-200 border-t-0 rounded-b-md px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-primary min-h-[1px]"
          style={{ minHeight: `${minHeightPx}px` }}
